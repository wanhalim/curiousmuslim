...
import {AnswerQuestionFiqh} from '../actions'
...
class Edit extends Component {
  ...
  submit = () =>{
    ...
    this.props.AnswerQuestionFiqh(this.state.answer, this.state.key);
...
export default connect(null, {AnswerQuestionFiqh})(Edit);
